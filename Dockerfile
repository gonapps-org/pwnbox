...
RUN apk update && apk add --no-cache bash musl-dev git gcc vim less gdb openssl-dev file nasm socat python2-dev py2-pip make libffi-dev g++ cmake
...
RUN git clone https://github.com/0vercl0k/rp /opt/rp
