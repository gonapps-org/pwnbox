...
RUN apk update && apk add --no-cache bash musl-dev git gcc vim less gdb openssl openssl-dev file nasm socat python2-dev py2-pip make libffi-dev g++ cmake libc6-compat
